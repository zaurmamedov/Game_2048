...
game.getStatus(); // Write your code here
...
class Game {
    ...
    moveLeft() {
        ...
        for(let r = 0; r < this.rows; r++){
            ...
            this.board[r] = newRow;
            if (!moved && newRow.some((num, i)=>num !== oldRow[i])) moved = true;
            for(let c = 0; c < this.columns; c++){
    ...
    moveUp() {
        ...
        for(let c = 0; c < this.columns; c++){
            const oldCol = [];
            for(let r = 0; r < this.rows; r++)oldCol.push(this.board[r][c]);
            const newCol = this.slide(oldCol);
            for(let r = 0; r < this.rows; r++){
                if (!moved && this.board[r][c] !== newCol[r]) moved = true;
   ...
   */ getStatus() {
        ...
        for(let r = 0; r < this.rows; r++){
            for(let c = 0; c < this.columns; c++)if (this.board[r][c] === 2048) {
        ...
        for(let r = 0; r < this.rows; r++)for(let c = 0; c < this.columns; c++){
            if (this.board[r][c] === 0) movesAvailable = true;
            if (c < this.columns - 1 && this.board[r][c] === this.board[r][c + 1]) movesAvailable = true;
            if (r < this.rows - 1 && this.board[r][c] === this.board[r + 1][c]) movesAvailable = true;
        }
        if (!movesAvailable) {
